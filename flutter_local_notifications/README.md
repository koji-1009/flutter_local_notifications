...
This library has a dependency on [GSON](https://github.com/google/gson). Therefore, according to this [link](https://developer.android.com/studio/build/shrink-code#keep-code), you need to adjust your ProGuard configuration file before building the release build of your application. These rules can be found [here](https://github.com/google/gson/blob/master/examples/android-proguard-example/proguard.cfg).
However, this configuration is difficult to understand without experience in Android development. So the library contains GSON ProGuard rules according to the [guide](https://developer.android.com/studio/projects/android-library#Considerations). In most cases the automatically inserted rules will solve the problem. If you encounter problems, please refer to the [guide](https://developer.android.com/studio/projects/android-library#Considerations) and add the rules manually.
